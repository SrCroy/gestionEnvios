                                        ...
                                        <tbody>
                                            @foreach($paquetesDisponibles as $paquete)
                                                <tr>
                                                    ...
                                                    <td>{{ number_format($paquete->altura, 2) }}</td>
                                ...
                                <div class="text-center mt-3">
                                    ...
                                    <div class="mt-3">
                                        <p class="text-muted">
                                            ...
                                            <span>
                                                {{ !$paqueteSeleccionado ? 'No hay paquete seleccionado' : '' }}
                                                {{ !$vehiculoAsignado ? 'No hay vehículo asignado' : '' }}
                                                {{ $porcentajeUso >= 100 ? 'Capacidad máxima alcanzada' : '' }}
                                            </span>
                                        </p>
                                    </div>
...
<script>
    ...
    document.addEventListener('livewire:load', function () {
        function seleccionarPaquete(paqueteId) {
            ...
            Livewire.emit('setPaqueteSeleccionado', paqueteId);
            console.log('Paquete seleccionado:', paqueteId); // Log para depuración
        }

        // Hacer que la función esté disponible globalmente
        window.seleccionarPaquete = seleccionarPaquete;
    });
