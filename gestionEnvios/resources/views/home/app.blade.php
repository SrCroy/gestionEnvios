...
<body>
    ...
    <div class="sidebar p-0" id="sidebar">
        ...
        <div class="p-3 mt-auto border-top border-light small text-white-50">
            ...
            <div class="mb-2"><i class="bi bi-geo-alt me-2"></i>Carretera al Cuco Km 144</div>
    ...
    <div class="content p-0">
        ...
        <nav class="navbar navbar-expand-lg bg-white shadow-sm">
            <div class="container-fluid">
                ...
                <span class="navbar-brand"><i class="bi bi-building me-2"></i>UES FMO - Centro de Distribución</span>
                ...
                <div class="navbar-nav ms-auto">
                    <div class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item"><i class="bi bi-person me-2"></i>Perfil</a></li>
                            <li><a class="dropdown-item"><i class="bi bi-gear me-2"></i>Configuración</a></li>
