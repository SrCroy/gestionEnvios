        ...
        <div class="container-fluid p-4">
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="email" name="emailMotorista" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label class="form-label" for="passwordMotorista">Contraseña del motorista:</label>
                    <input class="form-control" type="text" name="passwordMotorista">
                </div>
                <div class="mb-3">
                    <button type="submit">Registrar Motorista</button>
                </div>
